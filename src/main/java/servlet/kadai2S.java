...
/**
 * Servlet implementation class kadai2S
 */
@WebServlet("/kadai2S")
public class kadai2S extends HttpServlet {
...
request.getParameter("UTF-8");
		...
		if(salt == null) {
			String view = "WEB-INF/view/kadai2L.jsp?error=1";
		...
		kadai1dto account = kadai1dao.kadailogin(mail, hashedPw);
		...
		if(account == null) {
			...
			String view = "WEB-INF/view/kadai2C.jsp";
			RequestDispatcher dispatcher = request.getRequestDispatcher(view);
			dispatcher.forward(request, response);
		}
	}
